...
Table~\ref{tab:grammar-evolution} summarizes the three grammar versions developed during this work. The evolution proceeded through two distinct phases: weight rebalancing (v3.0 to v3.1) and structural expansion (v3.1 to v3.2).
